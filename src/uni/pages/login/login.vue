<template>
	<view style="padding: 40rpx;">
		<view
			...
			<view style="margin: 50rpx 30rpx; font-size: 40rpx;">
				欢迎登录
			</view>
			<uni-forms ref="form" :modelValue="form" :rules="rules" validateTrigger='blur'>
				...
				<uni-forms-item>
					<button @click="login()"
						style=" background-image: linear-gradient(to right,#9080a4, #c56b90);height: 70rpx;line-height: 70rpx;color: aliceblue;">
						登 录
					</button>
				</uni-forms-item>
				<uni-forms-item>
					<view style="text-align: right;margin-right: 20rpx;">还没有账号？去
						<navigator style="display: inline-block;color: dodgerblue;margin-left: 4rpx;"
