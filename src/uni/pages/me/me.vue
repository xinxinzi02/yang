	...
	<view  style="padding: 20rpx;">
		<view class="box" style="display: flex; align-items: center; margin-bottom: 20rpx;">
			...
			<view style="flex: 1; margin-left: 30rpx;">
				<view style="margin-bottom: 20rpx; font-size: 32rpx;">{{ user.name }}</view>
				<view style="color: #888;">{{ user.username }}</view>
			</view>
		</view>
		<view class="box" style="margin-bottom: 20rpx;">
			<view style="font-size: 36rpx; font-weight: bold; margin-bottom: 20rpx;">我的功能</view>
			<view style="display: flex;">
				<navigator url="/pages/address/address" class="me-item">
					<!-- mode="widthFix" 表示图片的宽度将被固定，而高度将按比例自动调整，以适应指定的宽度。 -->
					<image src="@/static/icons/gouwu-2.png" style="width: 50%;" mode="widthFix"></image>
					<view>收货地址</view>
				</navigator>
				<navigator url="/pages/collect/collect" class="me-item">
					<image src="@/static/icons/meiguihua.png" style="width: 50%;" mode="widthFix"></image>
					<view>我的收藏</view>
				</navigator>
				<navigator url="/pages/commentCenter/commentCenter" class="me-item">
					<image src="@/static/icons/huiyi.png" style="width: 50%;" mode="widthFix"></image>
					<view>评价中心</view>
				</navigator>
				<navigator url="" class="me-item">
					<image src="@/static/icons/baoguo.png" style="width: 50%;" mode="widthFix"></image>
					<view>浏览历史</view>
				</navigator>
			</view>
		</view>
