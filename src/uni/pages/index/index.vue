<template>
	<view>
		...
		<view style="padding: 20rpx;">
			...
			<view class="box" style="margin: 20rpx 0;">
				<view style="display: flex;">
					<view class="category-item" @click="goBusiness('奶茶饮品')">
						<image src="@/static/imgs/jiweijiu.png" mode="widthFix" style="width: 50%;"></image>
						<text>奶茶饮品</text>
					</view>
					<view class="category-item" @click="goBusiness('轻食简餐')">
						<image src="@/static/imgs/lizhi.png" mode="widthFix" style="width: 50%;"></image>
						<text>轻食简餐</text>
					</view>
					<view class="category-item" @click="goBusiness('炸鸡汉堡')">
						<image src="@/static/imgs/hanbao.png" mode="widthFix" style="width: 50%;"></image>
						<text>炸鸡汉堡</text>
					</view>
					<view class="category-item" @click="goBusiness('特色美味')">
						<image src="@/static/imgs/kaochuan.png" mode="widthFix" style="width: 50%;"></image>
						<text>特色美味</text>
					</view>
				</view>
			</view>
			...
			<!-- 商家列表 -->
			<view class="box" style="color: #d74582;font-size: 32rpx;font-weight: bold;margin-bottom: 20rpx"  >
				热门商家
			</view>
			...
			<view class="box" v-for="item in businessList" :key="item.id"
				...
				<view style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; grid-gap: 10rpx;">
					...
					<view style="display: flex;  color: #666; ">
						<view style="flex: 1;">
							<text style="color: #9080a4; font-weight: bold;">{{ item.score }}分</text>
							<text style="margin-left: 10rpx;">已售{{ item.nums  }}</text>
						</view>
            <view>
						<text style="flex: 1; text-align: right;">30分钟内送达</text>
            </view>
					</view>

					<view style="color: #9080a4;">免配送费</view>

					<view style=" color: #d74582; border-radius: 4rpx; width: fit-content;">
				        {{ item.info || '商家介绍' }}
					</view>
