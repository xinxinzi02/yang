<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入用户名称查询" style="width: 200px; margin-left: 10px" v-model="userName"></el-input>
      <el-input placeholder="请输入订单号称查询" style="width: 200px; margin-left: 10px" v-model="orderNo"></el-input>
