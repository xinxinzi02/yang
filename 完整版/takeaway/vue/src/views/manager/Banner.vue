<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入商家名称查询" style="width: 200px" v-model="businessName"></el-input>
    ...
    <el-dialog title="广告管理" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
