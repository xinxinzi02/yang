...
public class CartController {
     ...
     */
    @GetMapping("/calc")
     private Result calc(@RequestParam Integer userId, @RequestParam Integer businessId){
    ...
    public Result deleteBusiness(@PathVariable Integer businessId , @PathVariable Integer userId) {
